...
def features_select(df, name_target, max_cardinality=20):
    """creates features, and target from data frame, takes dataframe, name of
    feature in strings, and has an optional 3rd parameter of max cardinality allowed"""
    target = name_target
    # creating subsets of features, split between numerical and categorical
